...
export function About() {
  ...
  return (
    <ContainerWrapper id={sectionId} className="relative">
      <HeadingSection sectionId={sectionId} order="01" title="Sobre mim" />

      <div ref={sectionRef} className="grid gap-8 mb-12 md:grid-cols-3">
        <AnimateFrame sectionId={sectionId} className="md:col-span-2">
          <div className="space-y-4">
            ...
            <p className="leading-relaxed text-muted-foreground">
              ...
              , sempre com foco em performance, acessibilidade e experiência do
              usuário.
            </p>
        ...
        <AnimateFrame sectionId={sectionId} position="right">
          <div
            className="
